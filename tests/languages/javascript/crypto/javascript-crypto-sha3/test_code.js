...
function basicSHA3() {
  ...
  const hasher1 = crypto.createHash('sha3-224');
  const hasher2 = crypto.createHash('sha3-256');
  const hasher3 = crypto.createHash('sha3-384');
  const hasher4 = crypto.createHash('sha3-512');
